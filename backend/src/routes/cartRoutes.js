...
import { addToCart, clearCartItems, getAllCartItems, removeCartItem, updateCartQuantity } from '../controllers/cartController.js';
...
router.delete("/cart/clear", userAuth, clearCartItems);
