        ...
        <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
          ...
          <div className="border-t border-slate-100 py-3">
            ...
            <NavLink
              to="/cart"
              onClick={onClose}
              className="flex relative items-center gap-3 px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50"
            >
              <FiShoppingCart
                className="relative flex text-lg items-center justify-center  text-slate-700 transition hover:bg-slate-100"
                aria-label={
                  isAuthenticated
              ...
              {!isLoading && totalItems > 0 && (
                <span className="absolute right-4 top-2.5 flex min-h-5 min-w-5 items-center justify-center rounded-full bg-red-500 px-1 text-[11px] font-bold text-white">
                  {displayCount}
                </span>
              )}
            </NavLink>
